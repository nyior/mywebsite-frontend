    ...
    <div class="row m-2">
      ...
      <div class="col-12  text-left">
		...
		<ul class="list-inline">
            <li class="list-inline-item"  v-for="keyword in series.keywords" :key="keyword.id">
...
.text-rd{
	font-style: italic;
  background-color: #f42c5a; 
  border: 0.1rem solid #f42c5a;
  border-radius: 20rem;
}
