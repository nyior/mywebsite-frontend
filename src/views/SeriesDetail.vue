  ...
  <div>
    <div class="row  d-flex justify-content-center text-center hero-text-first">
      <div class="col-12">
        ...
        <h1 class="sub-heading-smaller text-muted mt-2">
          Started: {{ series.duration }} ago
        </h1>
      </div>
    ...
    <div
      class="row px-4 d-flex justify-content-center text-center  mt-5 mb-5"
      v-if="series.posts.length > 0"
    >
      <div
        class="col-12 col-md-3 card allround-shadow p-4 mt-3 mb-3"
